...
output:
  html_document:
    df_print: paged
---
## Título corto: Tiempo_Salud_Rendimiento
## P1 Primera entrega
### **Sección:** 1.01
...
El objetivo de esta investigación es analizar e informar acerca del impacto del tiempo de viaje desde la residencia de un alumno hasta la universidad en su salud mental y rendimiento académico. Con la información recogida, se desea responder a las preguntas planteadas y llegar a conclusiones representativas.

### Factibilidad

Probablemente ya se han desarrollado investigaciones parecidas a la nuestra, las que buscan saber si hay una relación entre cuán lejos vive un alumno de su universidad y las notas que obtiene. Sin embargo, éstas se centran solo en el factor académico, no analizan más allá. Para poder entender el comportamiento del alumno es necesario analizar el plano mental, pues es el encargado de regir nuestras acciones.Es así que nuestro proyecto buscará comprender el impacto en la salud mental al igual que en el rendimiento académico, valorizando al estudiante en su totalidad.
...
4|¿Cómo se sienten al momento de transportarse?
...
7|¿Es posible relacionar el nivel de estrés al que se somete un estudiante según el medio de transporte que toma para ir a la UTEC?
...
Ciclo cursante|8 y 9|Numérica discreta
Cantidad de cursos que llevaste el ciclo 2019-2|3|Numérica discreta
...
Nivel de eficiencia al transportarse|10|Categórica ordinal
Nivel de estrés|7 y 12|Categórica ordinal
Calidad de ayuda psicológica|11|Categórica ordinal
