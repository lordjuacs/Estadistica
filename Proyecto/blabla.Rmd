...
El objetivo de esta investigación es analizar e informar acerca del impacto del viaje desde la residencia de un alumno hasta la universidad en su tiempo efectivo de trabajo y rendimiento académico.Además también mediante este análisis, se buscará comprender la relación de los nivles de estrés correspondientes a cada alumno, con respecto a su rendimiento. Con la información recogida, se desea responder a las preguntas planteadas y llegar a conclusiones representativas.
...
Para las pruebas de t.test consideramos en la desviación estándr de la muestra, como la desviación estádar real, dado que la muestra supera los 30 individuos. 
...
Según los modelos evaluados en las relaciones entre las distintas variables, podemos concluir los siguiente:
 
-Los modelos planteados para las medias en cuanto a los intervaos de confianza, mostraron cierta efectividad.

-Una vez evaluados la relación en de las variables con otras, no se pudo identificar resultados relevantes que afirmen alguna conexión entre las variables planteadas.

-Con los resultados obtenidos, concluímos que si bien se puede observar una cierta inclinación por parte de los estudiantes, con respecto a la cantidad que tienen disponible para estudiar y que tanto estrés pueden generar los distintos medios de transporte, no se puede afirmar que el tiempo de transporte entre el alumno y su lugar de residencia impacte de manera negativa en sus estudios.
